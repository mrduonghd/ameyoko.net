...
<head>
    ...
    <title>送信エラー｜上野アメ横商店街公式サイト</title>

    <!-- Social Share - Facebook -->
    <meta property="og:type" content="article">
    <meta property="og:locale" content="ja_JP">
    <meta property="og:url" content="https://www.ameyoko.net/contact/error.html">
    <meta property="og:image" content="https://www.ameyoko.net/shared/img/shared/ogp.png">
    <meta property="og:title" content="送信エラー｜上野アメ横商店街公式サイト">
    <meta property="og:site_name" content="送信エラー｜上野アメ横商店街公式サイト">
    ...
    <!-- Profiles -->
    <link rel="canonical" href="https://www.ameyoko.net/contact/error.html">
    ...
    <section class="nav-target">
        <div id="contact">
            <div class="wrap wow fadeInUp">
                <div class="page_thanks txt-center">
                    <dl>
                        <dt>メッセージの送信に失敗しました</dt>
                        <dd>この度は、お問い合わせいただき誠にありがとうございます。<br class="pc">誠に申し訳ございませんが、システムエラーにてお問い合わせ内容が送信できませんでした。<br class="pc">誠に恐れ入りますが、再度お問い合わせフォームにてご入力・送信をお願い申し上げます。</dd>
                    </dl>
                    <p class="btn"><a href="index.php">お問い合わせに戻る</a></p>
                </div>
            </div>
        </div>
    </section>
